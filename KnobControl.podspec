...
Pod::Spec.new do |s|
 ...
 s.license      = "MIT"
  ...
  s.author             = { "Ajas" => "" }
  # Or just: s.author    = "Ajas"
  # s.authors            = { "Ajas" => "" }
  # s.social_media_url   = "http://twitter.com/Ajas"
...
s.source       = { :git => "/Users/precise/Desktop/iOS\ Projects/Cocopods_Demo/KnobShowcase/repo/KnobControl", :tag => "1.0.0" }
